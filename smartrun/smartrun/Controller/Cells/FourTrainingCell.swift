...
class FourTrainingCell: UITableViewCell {
    ...
    // MARK: Cell D
    @IBOutlet weak var timesLabelD: UILabel!
    ...
    func fill(_ training: Training) {
        ...
        // Cell D
        self.timesLabelD.text = training.listExercise[3].getTimes()
